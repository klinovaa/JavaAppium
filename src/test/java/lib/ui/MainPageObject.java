...
public class MainPageObject {
    ...
    {
        WebElement titleElement = waitForElementPresent(locator, error_message);
    ...
    public void clickElementToTheRightUpperCorner(String locator, String error_message)
    {
        if (driver instanceof AppiumDriver) {
            ...
            System.out.println("Method clickElementToTheUpperCorner() does nothing for platform " + Platform.getInstance().getPlatformVar());
        }
    }
    ...
    public void assertElementPresent(String locator, String error_message)
    {
        int amount_of_elements = getAmountOfElements(locator);
        if (amount_of_elements == 0) {
            String default_message = "An element '" + locator + "' should be present";
            throw new AssertionError(default_message + " " + error_message);
        }
    }
    ...
    private By getLocatorByString(String locator_with_type) //type:locator // id: some id // xpath:some xpath
    {
